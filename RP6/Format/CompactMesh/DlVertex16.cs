...
public struct DlVertex16
{
    ...
    public static (
        ...
        float[] uv0Array,
        float[] uv1Array
    ) ExtractArrays(DlVertex16[] vertices, int vertexCount = 0)
    {
        ...
        for (var i = 0; i < vertexCount; i++)
        {
            ...
            positionBuffer[i * 3 + 0] = (float)v.PX;
            positionBuffer[i * 3 + 1] = (float)v.PY;
            positionBuffer[i * 3 + 2] = (float)v.PZ;
