...
//texture
    ...
    private readonly static Dictionary<EFormat, DDS.DXGI_FORMAT> TextureToDXGIMap = new()
    {
        ...
        {
            EFormat.B32G32R32F, DDS.DXGI_FORMAT.DXGI_FORMAT_R32G32B32_FLOAT
        ...
        {
            EFormat.A2R10G10B10, DDS.DXGI_FORMAT.DXGI_FORMAT_R10G10B10A2_UNORM
        }, // D3D9 ordering may differ; use R10G10B10A2
        {
            EFormat.A2R10G10B10_GAMMA, DDS.DXGI_FORMAT.DXGI_FORMAT_R10G10B10A2_UNORM
        ...
        {
            EFormat.D24FS8, DDS.DXGI_FORMAT.DXGI_FORMAT_R24_UNORM_X8_TYPELESS
        ...
        public static Info Get(EFormat fmt)
        {
            return fmt switch
            {
                ...
                EFormat.BC1_UNORM
                    => new Info
                    {
                        IsBlockCompressed = true, BlockSizeBytes = 8
                ...
                EFormat.BC2_UNORM or
                    ...
                    => new Info
                    {
                        IsBlockCompressed = true, BlockSizeBytes = 16
                    }, // BC2/3/5/6/7: 16 bytes per 4x4 block
